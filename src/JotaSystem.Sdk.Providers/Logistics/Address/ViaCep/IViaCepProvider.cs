...
namespace JotaSystem.Sdk.Providers.Logistics.Address.ViaCep
{
    ...
    public interface IViaCepProvider
    {
        ...
        /// </summary>
        Task<ApiResponse<ViaCepResult?>> GetAddressByCepAsync(string cep, CancellationToken cancellationToken = default);
        ...
        /// </remarks>
        Task<ApiResponse<IEnumerable<ViaCepResult>>> GetCepsByAddressAsync(string state, string city, string street, CancellationToken cancellationToken = default);
    }
}